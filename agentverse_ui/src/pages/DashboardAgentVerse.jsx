    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          {stats.map((stat, idx) => (
            <div key={idx} className="av-card text-center group hover:border-purple-500/50 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {quickActions.map((action, idx) => (
            ...
            >
              <div className="av-card hover:scale-105 transition-all duration-300 hover:border-purple-500/50">
        ...
        {/* Workflow Section */}
        <div className="av-card mb-8 overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-8 flex-wrap">
            {workflowSteps.map((step, idx) => (
              <React.Fragment key={idx}>
                <div className="group">
                  <div className="av-node hover:border-purple-500/50 hover:scale-105 transition-all cursor-pointer">
        ...
        <div className="text-center">
          <div className="av-card inline-block px-12 py-10">
            <h2 className="text-3xl font-bold mb-4 text-white">
              Ready to build intelligent AI agents?
            </h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto text-lg">
              Join thousands of developers using Agent Verse to create powerful AI applications
