...
- Focus on rapid mitigation first, then root cause"""
    ...
    def _setup_mcp_tools(self):
        ...
        # Register instance methods as MCP tools
        self.mcp.tool()(self.respond_to_incident)
        self.mcp.tool()(self.update_incident_status)
        self.mcp.tool()(self.calculate_error_budget)
        self.mcp.tool()(self.perform_rca)
        self.mcp.tool()(self.execute_runbook)
        self.mcp.tool()(self.analyze_service_health)
